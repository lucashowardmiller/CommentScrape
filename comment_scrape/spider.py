...
def start_crawl(base_url: str, max_rps=9999, max_crawl=1000, obey_robots=False, user_agent="CommentScrape", print_progress=False):
    # Set up the crawler
    ...
    while crawl.total_scraped < max_crawl and len(crawl.pages_to_crawl) > 0:
        ...
        try:
            ...
            pass
        crawl.total_scraped += 1
        if print_progress and max_crawl % crawl.total_scraped == 10:
            print(f'Scraping is %{max_crawl % crawl.total_scraped} Done')
